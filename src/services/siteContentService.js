...
export const DEFAULT_SITE_CONTENT = {
  ...
  heroSubtitle:
    "Scientifically formulated 100% Whey Protein Isolates, organic oats, and elite athletic supplements engineered for rapid muscle recovery.",
  ...
  footerDescription:
    "Clean-label protein and oats, dosed and tested for people who actually train.",
  footerContactEmail: "support@rbprotein.com",
  footerContactPhone: "+91 7972940127",
  whatsappNumber: "917972940127",
  footerCopyrightText:
    "© 2026 RB_Protein. Website developed by JAYDIP.7972940127",
...
export function formatWhatsAppLink(phone, messageText = "") {
  const num = (
    phone ||
    memoryContent.whatsappNumber ||
    memoryContent.footerContactPhone ||
    "917972940127"
  ).replace(/\D/g, "");
  ...
  try {
    ...
    if (snap) {
      memoryContent = {
        ...
        ...snap,
        heroDeals: snap.heroDeals?.length
          ? snap.heroDeals
          : DEFAULT_SITE_CONTENT.heroDeals,
      };
